...
export const updateUser = (user) => async (dispatch, getState) => {
    try {
        ...
        //when we update a user we send the data to the userDetails in order to update its data, hence when we select the details reducer with from the store we get it with the updated data.
